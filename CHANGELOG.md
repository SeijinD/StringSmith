...
- Unit tests: `StringsXmlTextTest`, `KeyGeneratorTest`, `StringSmithSettingsTest`, `AndroidModuleTextTest`, `ExtractContextTest` (BasePlatformTestCase PSI fixtures; covers `@Preview` detection and format-arg extraction in Composable / Activity contexts).
